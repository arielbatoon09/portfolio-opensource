...
export function CTABanner() {
  return (
    <Section className="!py-12">
      <div className="bg-gradient-to-r from-black via-primary/95 dark:via-primary/10 to-black container max-w-screen-lg mx-auto px-4 flex flex-col items-center justify-center py-16 text-center space-y-6 md:rounded-lg">
